...
_id_to_string_dict = {
    ...
    "Acceptable_files": {"en": "Acceptable files", "ru": "Принимаемые файлы"},
    ...
    "Add_item": {"en": "Add item", "ru": "Добавить позицию"},
    "Apply": {"en": "Apply", "ru": "Применить"},
    "Apply_and_reload": {"en": "Apply and reload", "ru": "Применить и перезагрузить"},
    "Apply_config": {
        "en": "Apply config",
    ...
    "Are_you_sure": {"en": "Are you sure?", "ru": "Вы уверены?"},
    "AsyncX_monitor": {
        "en": "AsyncX monitor",
        "ru": "AsyncX монитор",
    },
    "Augment_pyramid": {"en": "Augment pyramid", "ru": "Пирамидная аугментация"},
    "Auto": {"en": "Auto", "ru": "Авто"},
    "Average_for": {
        "en": "Average for",
        "ru": "Среднее для",
    },
    "Backup": {"en": "Backup", "ru": "Резервная копия"},
    "Base_dimension": {
        "en": "Base dimension",
    ...
    "BW_mask": {"en": "B/W mask", "ru": "Ч/Б маска"},
    ...
    "Change_file_format": {"en": "Change file format", "ru": "Изменить формат файла"},
    "Channels_deform": {"en": "Channels deform", "ru": "Деформация каналов"},
    ...
    "Confidence": {"en": "Confidence", "ru": "Вероятность"},
    "Confirm": {"en": "Confirm", "ru": "Подтвердить"},
    "Copy_image": {"en": "Copy image", "ru": "Скопировать изображение"},
    "Copy_mask": {"en": "Copy mask", "ru": "Скопировать маску"},
    "Current_config": {
        "en": "Current config",
        "ru": "Текущая конфигурация",
    },
    "Cut": {"en": "Cut", "ru": "Вырезать"},
    "Cut_3p_bezier": {"en": "Cut 3p bezier", "ru": "Вырезать 3т безье"},
    "Cut_edges": {"en": "Cut edges", "ru": "Обрезка граней"},
    "Data_generator": {"en": "Data generator", "ru": "Генератор данных"},
    "Decrease_chance_similar": {
        "en": "Decrease chance of similar",
        "ru": "Уменьшить шанс похожих",
    },
    "Decrease_opacity": {"en": "Decrease opacity", "ru": "Уменьшить непрозрачность"},
    ...
    "Deleting_metadata": {"en": "Deleting metadata", "ru": "Удаление метаданных"},
    "Depth": {"en": "Depth", "ru": "Глубина"},
    "Device": {"en": "Device", "ru": "Устройство"},
    "Draw_annotations": {"en": "Draw annotations", "ru": "Рисовать аннотации"},
    "Dimension": {"en": "Dimension", "ru": "Размерность"},
    "Directory": {
        "en": "Directory",
        "ru": "Директория",
    },
    "Disable_export": {"en": "Disable export", "ru": "Отключить экспорт"},
    "Discard_if_more": {"en": "Discard if more", "ru": "Отбросить если более"},
    "Dist_from_center": {"en": "Dist from center", "ru": "Расстояние от центра"},
    "Effective_iteration_time": {
        "en": "Effective iteration time",
        "ru": "Эффективное время итерации",
    },
    "Enable_export": {"en": "Enable export", "ru": "Включить экспорт"},
    "Error": {"en": "Error", "ru": "Ошибка"},
    "Edit": {"en": "Edit", "ru": "Правка"},
    "Enhanced": {
        "en": "Enhanced",
        "ru": "Улучшенное",
    },
    "Enhancer": {"en": "Enhancer", "ru": "Улучшатель"},
    "End": {"en": "End", "ru": "Конец"},
    "Every": {"en": "Every", "ru": "Каждые"},
    "Export": {"en": "Export", "ru": "Экспорт"},
    "Export_DFL_mask": {"en": "Export DFL mask", "ru": "Экспорт DFL маски"},
    "Export_mesh_mask": {"en": "Export mesh mask", "ru": "Экспорт меш маски"},
    "Export_metadata": {"en": "Export metadata", "ru": "Экспорт метаданных"},
    "Face_aligner": {"en": "Face aligner", "ru": "Выравниватель лица"},
    "Face_coverage": {"en": "Face coverage", "ru": "Покрытие лица"},
    "Face_detector": {"en": "Face detector", "ru": "Детектор лица"},
    "Face_identifier": {"en": "Face identifier", "ru": "Идентификатор лица"},
    ...
    "Face_marker": {"en": "Face marker", "ru": "Маркер лица"},
    "Face_pitch": {"en": "Face pitch", "ru": "Наклон лица"},
    "Face_realign": {"en": "Face realign", "ru": "Перевыровнить лицо"},
    "Face_source_size": {"en": "Face source size", "ru": "Размер лица в исходнике"},
    "Face_yaw": {"en": "Face yaw", "ru": "Поворот лица"},
    "Face_Y_offset": {"en": "Face Y offset", "ru": "Смещение лица по Y"},
    "Face_Y_axis_offset": {"en": "Face Y axis offset", "ru": "Смещение Y оси"},
    "File": {"en": "File", "ru": "Файл"},
    "File_format": {"en": "File format", "ru": "Формат файла"},
    "File_state_manager": {
        "en": "File state manager",
        "ru": "Менеджер файлового состояния",
    },
    "Fill": {"en": "Fill", "ru": "Залить"},
    "Fill_3p_bezier": {"en": "Fill 3p bezier", "ru": "Залить 3т безье"},
    ...
    "Gathering_metadata": {"en": "Gathering metadata", "ru": "Сбор метаданных"},
    "Generate": {"en": "Generate", "ru": "Генерация"},
    "Generate_preview": {"en": "Generate preview", "ru": "Генерация превью"},
    "Generalization_level": {
        "en": "Generalization level",
        "ru": "Уровень обобщения",
    },
    "Generating": {"en": "Generating", "ru": "Генерация"},
    "Gray_image": {"en": "Gray image", "ru": "Серое изображение"},
    "Green": {"en": "Green", "ru": "Зелёный"},
    "Half_edge": {"en": "Half edge", "ru": "Уполовинить грань"},
    "Help": {
        "en": "Help",
        "ru": "Помощь",
    },
    ...
    "Hold": {"en": "Hold", "ru": "Удерживать"},
    "Increase_opacity": {"en": "Increase opacity", "ru": "Увеличить непрозрачность"},
    "Input_image": {"en": "Input image", "ru": "Входное изображение"},
    "Interpolation": {"en": "Interpolation", "ru": "Интерполяция"},
    "Image": {"en": "Image", "ru": "Изображение"},
    "Image_and_mask": {"en": "Image and mask", "ru": "Изображение и маска"},
    "Image_and_gray_image": {
        "en": "Image and gray image",
        "ru": "Изображение и серое изображение",
    },
    "Image_size": {"en": "Image size", "ru": "Размер изображения"},
    "Image_index": {
        "en": "Image index",
        "ru": "Индекс изображения",
    },
    "Import": {"en": "Import", "ru": "Импорт"},
    "Import_metadata": {"en": "Import metadata", "ru": "Импорт метаданных"},
    "Info": {"en": "Info", "ru": "Инфо"},
    "Input_channel_type": {"en": "Input channel type", "ru": "Тип входного канала"},
    "Input_directory": {"en": "Input directory", "ru": "Входная директория"},
    "Invert_selection": {"en": "Invert selection", "ru": "Инвертировать выделенное"},
    ...
    "Largest": {"en": "Largest", "ru": "Наибольшему"},
    "Learning_rate": {
        "en": "Learning rate",
        "ru": "Скорость обучения",
    },
    "Left_to_right": {"en": "Left to right", "ru": "Слева направо"},
    "Levels_range": {"en": "Levels range", "ru": "Диапазон уровней"},
    "Levels_shift": {
        "en": "Levels shift",
        "ru": "Смещение уровней",
    },
    ...
    "Loading_meta_data": {"en": "Loading meta data", "ru": "Загрузка мета данных"},
    "Luminance": {
        "en": "Luminance",
        "ru": "Яркость",
    },
    ...
    "Maximum": {"en": "Maximum", "ru": "Максимум"},
    ...
    "Menu_unselected": {"en": "-- unselected --", "ru": "-- не выбрано --"},
    ...
    "Min_face_size": {"en": "Min face size", "ru": "Минимальный размер лица"},
    "Minimum_confidence": {"en": "Minimum confidence", "ru": "Минимальная вероятность"},
    ...
    "Moving": {"en": "Moving", "ru": "Перемещение"},
    "Name": {"en": "Name", "ru": "Имя"},
    "Navigation": {"en": "Navigation", "ru": "Навигация"},
    "Next": {"en": "Next", "ru": "Следующий"},
    "Network_type": {"en": "Network type", "ru": "Тип сети"},
    "New": {"en": "New", "ru": "Новый"},
    "No_image_selected": {
    ...
    "Not_applied": {"en": "Not applied", "ru": "Не применено"},
    "Offset": {
        "en": "Offset",
        "ru": "Смещение",
    },
    ...
    "Overlap_threshold": {"en": "Overlap threshold", "ru": "Порог перекрытия"},
    "Output_channel_type": {"en": "Output channel type", "ru": "Тип выходного канала"},
    "Overlay": {"en": "Overlay", "ru": "Оверлей"},
    "Output_directory": {"en": "Output directory", "ru": "Выходная директория"},
    "Output_type": {"en": "Output type", "ru": "Выходной тип"},
    "Paired_image": {"en": "Paired image", "ru": "Парное изображение"},
    "Pair_type": {"en": "Pair type", "ru": "Тип пары"},
    "Pass_count": {"en": "Pass count", "ru": "Число проходов"},
    "Paste_mask": {"en": "Paste mask", "ru": "Вставить маску"},
    "Patch_mode": {
        "en": "Patch mode",
        "ru": "Режим патча",
    },
    ...
    "Rate": {"en": "Rate", "ru": "Шанс"},
    "Reconstruction": {"en": "Reconstruction", "ru": "Реконструкция"},
    "Red": {"en": "Red", "ru": "Красный"},
    "Redo": {"en": "Redo", "ru": "Повторить"},
    "Reload": {"en": "Reload", "ru": "Перезагрузить"},
    "Remove_item": {"en": "Remove item", "ru": "Убрать позицию"},
    "Renaming": {"en": "Renaming", "ru": "Переименовывание"},
    ...
    "Reveal_in_explorer": {"en": "Reveal in explorer", "ru": "Открыть в проводнике"},
    "Right_to_left": {"en": "Right to left", "ru": "Справа налево"},
    "Rotation": {
        "en": "Rotation",
        "ru": "Поворот",
    },
    ...
    "Segmentator": {"en": "Segmentator", "ru": "Сегментатор"},
    "Scale": {
        "en": "Scale",
        "ru": "Масштаб",
    },
    "Selected": {"en": "Selected", "ru": "Выделено"},
    "Select_marked": {"en": "Select marked", "ru": "Выделить помеченное"},
    "Select_unselect_all": {"en": "Select/unselect all", "ru": "Выбрать/убрать все"},
    "Sharpen": {
        "en": "Sharpen",
        "ru": "Резкость",
    },
    "Show_file_name": {"en": "Show file name", "ru": "Показывать имя файла"},
    "Show_file_extension": {
    ...
    "Show_lines_size": {"en": "Show lines size", "ru": "Показать размеры линий"},
    "Show_hide_console": {
        "en": "Show/hide console",
        "ru": "Показать/скрыть консоль",
    },
    "Smooth_corner": {"en": "Smooth corner", "ru": "Сгладить угол"},
    "Sort": {"en": "Sort", "ru": "Сортировка"},
    "Sorting": {"en": "Sorting", "ru": "Сортировка"},
    "Sort_by": {"en": "Sort by", "ru": "Отсортировать по"},
    ...
    "Start_training": {"en": "Start training", "ru": "Начать тренировку"},
    "State": {"en": "State", "ru": "Состояние"},
    "State_name": {"en": "State name", "ru": "Имя состояния"},
    "Static_augmentations": {
        "en": "Static augmentations",
        "ru": "Статичные аугментации",
    },
    "Step": {"en": "Step", "ru": "Шаг"},
    "Stop_training": {"en": "Stop training", "ru": "Остановить тренировку"},
    "Success": {"en": "Success", "ru": "Успешно"},
    "Swap": {"en": "Swap", "ru": "Замена"},
    "Swapper": {"en": "Swapper", "ru": "Заменитель"},
    "Swap_enhanced": {"en": "Swap enhanced", "ru": "Улучшенная замена"},
    ...
    "Thumbnail_size": {"en": "Thumbnail size", "ru": "Размер эскиза"},
    "Toggle": {
        "en": "Toggle",
        "ru": "Сменить",
    },
    ...
    "Train": {"en": "Train", "ru": "Тренировать"},
    "Trainer": {"en": "Trainer", "ru": "Тренер"},
    "Training_error": {"en": "Training error", "ru": "Ошибка тренировки"},
    ...
    "Trash_directory": {"en": "Trash directory", "ru": "Директория для мусора"},
    "Trash_selected": {"en": "Trash selected", "ru": "Выбросить выделенное"},
    "Type": {
        "en": "Type",
        "ru": "Тип",
    },
    ...
    "View": {"en": "View", "ru": "Вид"},
    "Video_file": {"en": "Video file", "ru": "Видео файл"},
    "Image_sequence": {"en": "Image sequence", "ru": "Ряд изображений"},
    # Lower case
    "and_next": {"en": "and next", "ru": "и следующий"},
    "and_previous": {"en": "and previous", "ru": "и предыдущий"},
    "backups": {"en": "backups", "ru": "копий"},
    "by_pair_type": {"en": "by pair type", "ru": "по типу пары"},
    "by_name": {"en": "by name", "ru": "по имени"},
    "error": {"en": "error", "ru": "ошибка"},
    "dimension": {"en": "dimension", "ru": "размерность"},
    "it_s": {"en": "it/s", "ru": "ит/c"},
    "minutes": {"en": "minutes", "ru": "минут"},
    "no_items": {"en": "no items", "ru": "нет элементов"},
    "no_pair": {"en": "no pair", "ru": "нет пары"},
    "open_the_source": {"en": "open the source", "ru": "откройте источник"},
    "open_the_dataset": {"en": "open the dataset", "ru": "откройте датасет"},
    "per_second": {"en": "per second", "ru": "в секунду"},
    "second": {
        "en": "second",
        "ru": "секунд",
    },
    "with_mask": {"en": "with mask", "ru": "с маской"},
