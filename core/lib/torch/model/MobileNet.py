...
class MobileNet(nn.Module):
    def __init__(self, in_ch, out_ch, width_mult=1.0):
        ...
        self.c0 = c0 = ConvNormActivation(
            in_ch,
            _make_divisible(16 * width_mult, 8),
            kernel_size=3,
            stride=2,
            norm_layer=norm_layer,
            activation_layer=nn.Hardswish,
        )
        self.c1 = c1 = InvertedResidual(
            c0.out_ch,
            16,
            16,
            3,
        ...
        self.c16 = c16 = ConvNormActivation(
            c15.out_ch,
            _make_divisible(6 * 160 * width_mult, 8),
            kernel_size=1,
            norm_layer=norm_layer,
            activation_layer=nn.Hardswish,
        )
