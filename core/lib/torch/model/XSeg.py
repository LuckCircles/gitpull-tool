...
class XSeg(nn.Module):
    def __init__(self, in_ch=1, out_ch=1, base_dim=32, depth=6, generalization_level=0):
        super().__init__()
    ...
    def forward(self, inp):
        ...
        for i, (shortcut_x, up_s, up_r, up_c) in enumerate(
            zip(shortcuts, self._up_s_list, self._up_r_list, self._up_c_list)
        ):
