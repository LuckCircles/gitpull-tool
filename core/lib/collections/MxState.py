...
class MxState(mx.Disposable, MutableMapping):
    ...
    def to_f_dict(self) -> FDict:
        return self._hf_dict.to_f_dict()
    ...
    def get(self, *args):
        return self._hf_dict.get(*args)

    def items(self) -> ItemsView:
        return self._hf_dict.items()

    def keys(self) -> KeysView:
        return self._hf_dict.keys()

    def values(self) -> ValuesView:
        return self._hf_dict.values()

    def __getitem__(self, key):
        return self._hf_dict.__getitem__(key)

    def __contains__(self, key) -> bool:
        return self._hf_dict.__contains__(key)

    # Collection
    def __len__(self) -> int:
        return self._hf_dict.__len__()

    # Iterable
    def __iter__(self) -> Iterator:
        return self._hf_dict.__iter__()
