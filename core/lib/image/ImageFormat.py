...
class ImageFormat:
    ...
    def __hash__(self) -> int:
        return (self._suffixes, self._bits_per_ch)
    ...
    def __eq__(self, other) -> bool:
        ...
        if isinstance(other, ImageFormat):
            return (
                ...
                and self._bits_per_ch == other._bits_per_ch
            )
        return False
...
FORMAT_JPEG = ImageFormat(
    suffixes=[".jpg", ".jpe", ".jpeg"], bits_per_ch=8, desc="JPEG"
)
FORMAT_JPEG2000 = ImageFormat(suffixes=[".jp2"], bits_per_ch=8, desc="JPEG2000")
FORMAT_JPEG2000_16 = ImageFormat(
    suffixes=[".jp2"], bits_per_ch=16, desc="JPEG2000-16bit"
)
...
FORMAT_TIFF_16 = ImageFormat(
    suffixes=[".tif", ".tiff"], bits_per_ch=16, desc="TIFF-16bit"
)
...
_fmt_by_type = {
    ImageFormatType.JPEG: FORMAT_JPEG,
