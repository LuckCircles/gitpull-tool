...
from ..wintypes import (BOOL, ERROR, GUID, HRESULT, REFGUID, REFIID, IUnknown,
...
class IDXGIAdapter1(IDXGIAdapter):
    ...
    def get_desc1(self) -> DXGI_ADAPTER_DESC1 | None:
...
class IDXGIFactory1(IDXGIFactory):
    ...
    def enum_adapters1(self, id: int) -> IDXGIAdapter1 | None:
...
def create_DXGIFactory1() -> IDXGIFactory1 | None:
...
def create_DXGIFactory2() -> IDXGIFactory2 | None:
...
def create_DXGIFactory3() -> IDXGIFactory3 | None:
...
def create_DXGIFactory4() -> IDXGIFactory4 | None:
