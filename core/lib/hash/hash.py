...
class Hash64Similarity:
    ...
    def add(self, hash_idx: int, hash: Hash64):
        ...
        """
        c_similarity_add(
            self._similarities.ctypes.data_as(cc.c_uint32_p),
...
def c_similarity_add(
    similarities: cc.c_uint32_p,
    hashed_map: cc.c_uint8_p,
    hashed_idxs: cc.c_uint32_p,
    hashes: cc.c_void_p,
    hashed_count: cc.c_uint32_p,
    hash_idx: cc.c_uint32,
    hash: cc.c_uint64,
    similarity_factor: cc.c_uint32,
) -> cc.c_void: ...
