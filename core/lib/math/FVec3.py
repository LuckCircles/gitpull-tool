...
class FVec3(FVec):
    ...
    def z(self) -> int | float:
        return self._python_type(self._values[2])
    ...
    @property
    def xyz(self) -> Tuple[int | float, int | float, int | float]:
...
class FVec3f(FVec3):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec3f | None:
        return FVec3._from_state(state, FVec3f)
...
class FVec3i(FVec3):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec3i | None:
        return FVec3._from_state(state, FVec3i)
