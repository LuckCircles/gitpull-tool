...
class FPoly2f(FVec2fArray):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FPoly2f | None:
        return FVec2fArray._from_state(state, FPoly2f)

    @cached_property
    def points(self) -> Sequence[FVec2f]:
    ...
    def dists_to_edges(
        self, pt: FVec2f
    ) -> Tuple[Sequence[float], Sequence[FVec2f]] | None:
