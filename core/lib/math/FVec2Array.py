...
class FVec2fArray(FVec2Array[FVec2f]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec2fArray | None:
        return FVec2Array._from_state(state, FVec2fArray)
...
class FVec2iArray(FVec2Array[FVec2i]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec2iArray | None:
        return FVec2Array._from_state(state, FVec2iArray)
