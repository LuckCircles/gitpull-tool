...
class FBBox(FNDArray, Generic[T], Iterable):
    ...
    def x(self) -> int | float:
        return self._python_type(self._values[0])

    @property
    def y(self) -> int | float:
        return self._python_type(self._values[1])

    @cached_property
    def width(self) -> int | float:
        return self._python_type(self._values[2] - self._values[0])

    @cached_property
    def height(self) -> int | float:
        return self._python_type(self._values[3] - self._values[1])

    @cached_property
    def pos(self) -> T:
        return self._T_type(self._values[0:2])

    @cached_property
    def size(self) -> T:
        return self._T_type(self.width, self.height)
    ...
    @property
    def rb(self) -> T:
        return self._T_type(self._values[2:4])
    ...
    def as_4pts(self) -> Tuple[FVec2f, FVec2f, FVec2f, FVec2f]:
        ...
        return (
            pos,
            T_type(pos.x + size.x, pos.y),
            T_type(pos.x + size.x, pos.y + size.y),
            T_type(pos.x, pos.y + size.y),
        )
...
class FBBoxf(FBBox[FVec2f]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FBBoxf | None:
        return FBBox._from_state(state, FBBoxf)
...
class FBBoxi(FBBox[FVec2i]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FBBoxi | None:
        return FBBox._from_state(state, FBBoxi)
