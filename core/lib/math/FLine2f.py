...
class FLine2f(FLine):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FLine2f | None:
        return FNDArray._from_state(state, FLine2f)
    ...
    @cached_property
    def p0(self) -> FVec2f:
        return FVec2f(self._values[0])

    @cached_property
    def p1(self) -> FVec2f:
        return FVec2f(self._values[1])
    ...
    def __getitem__(self, key: int) -> FVec2f:
        return FVec2f(*self._values[key])
