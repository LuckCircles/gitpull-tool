...
class FVec3fArray(FVec3Array[FVec3f]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec3fArray | None:
        return FVec3Array._from_state(state, FVec3fArray)
...
class FVec3iArray(FVec3Array[FVec3i]):
    ...
    @staticmethod
    def from_state(state: FDict | None) -> FVec3iArray | None:
        return FVec3Array._from_state(state, FVec3iArray)
