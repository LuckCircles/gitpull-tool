...
class QAbstractButton(QWidget):
    def __init__(self, **kwargs):
        super().__init__(
            q_widget=q_init(
                "q_abstract_button", _QAbstractButtonImpl, qt.QAbstractButton, **kwargs
            )
        )
    ...
    @property
    def q_abstract_button(self) -> qt.QPushButton:
        return self.q_widget

    @property
    def mx_clicked(self) -> mx.IEvent0_rv:
        return self._mx_clicked

    @property
    def mx_pressed(self) -> mx.IEvent0_rv:
        return self._mx_pressed

    @property
    def mx_released(self) -> mx.IEvent0_rv:
        return self._mx_released

    @property
    def mx_toggled(self) -> mx.IEvent1_rv[bool]:
        return self._mx_toggled

    @property
    def text(self) -> str:
        return self.q_abstract_button.text()

    def is_down(self) -> bool:
        return self.q_abstract_button.isDown()

    def is_checked(self) -> bool:
        return self.q_abstract_button.isChecked()
    ...
    def set_text(self, text: str | None):
        if (disp := getattr(self, "_QAbstractButton_text_disp", None)) is not None:
            disp.dispose()
        self._QAbstractButton_text_disp = (
            QApplication.instance()
            .mx_language.reflect(
                lambda lang: self.q_abstract_button.setText(lx.L(text, lang))
            )
            .dispose_with(self)
        )
        return self
