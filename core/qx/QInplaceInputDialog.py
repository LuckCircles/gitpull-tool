...
class QInplaceInputDialog(QVBox):
    ...
    def __init__(self):
        ...
        (
            self.add(self._q_label_title).add(
                QHBox()
    ...
    @property
    def q_label_title(self) -> QLabel:
        return self._q_label_title

    @property
    def q_lineedit(self) -> QLineEdit:
        return self._q_lineedit

    @property
    def q_btn_ok(self) -> QPushButton:
        return self._q_btn_ok

    @property
    def q_btn_cancel(self) -> QPushButton:
        return self._q_btn_cancel
