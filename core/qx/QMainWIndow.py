...
class QMainWIndow(QWindow):
    ...
    @property
    def q_central_vbox(self) -> QVBox:
        return self._q_central_vbox

    @property
    def q_menu_bar(self) -> QMenuBar:
        return self._q_menu_bar

    @property
    def q_top_bar_hbox(self) -> QHBox:
        return self._q_top_bar_hbox

    @property
    def q_info_bar(self) -> QInfoBar:
        return self._q_info_bar
