...
class QGrid(QLayout):
    ...
    def __init__(self, **kwargs):
        super().__init__(
            q_layout=q_init("q_grid_layout", qt.QGridLayout, **kwargs), **kwargs
        )

    @property
    def q_grid_layout(self) -> qt.QGridLayout:
    ...
    def row(self, row: int, col: int = 0) -> QGrid.Row:
        return QGrid.Row(self, row, col)

    def col(self, col: int, row: int = 0) -> QGrid.Col:
        return QGrid.Col(self, row, col)
