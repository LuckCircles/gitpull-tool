...
class QFontDB(mx.Disposable):
    ...
    def get(
        self, font: FontDB, size: Size | int = Size.Default, italic=False, bold=False
    ) -> qt.QFont:
...
Font_ESize_to_font_size = {
    FontDB.Default: {Size.XXL: 32, Size.XL: 22, Size.L: 14, Size.M: 8, Size.S: 6},
    FontDB.FixedWidth: {Size.XXL: 32, Size.XL: 22, Size.L: 14, Size.M: 8, Size.S: 6},
    FontDB.Digital: {Size.XXL: 32, Size.XL: 22, Size.L: 14, Size.M: 11, Size.S: 6},
}
