...
class QWidget(QObject):
    ...
    def __init__(self, **kwargs):
        ...
        self._minimumSizeHint_wrap = QFuncWrap(
            q_widget := self.q_widget,
            "minimumSizeHint",
            lambda *args, **kwargs: self._minimum_size_hint(*args, **kwargs),
        ).dispose_with(self)
        self._sizeHint_wrap = QFuncWrap(
            q_widget,
            "sizeHint",
            lambda *args, **kwargs: self._size_hint(*args, **kwargs),
        ).dispose_with(self)
        self._showEvent_wrap = QFuncWrap(
            q_widget,
            "showEvent",
            lambda *args, **kwargs: self._show_event(*args, **kwargs),
        ).dispose_with(self)
        self._hideEvent_wrap = QFuncWrap(
            q_widget,
            "hideEvent",
            lambda *args, **kwargs: self._hide_event(*args, **kwargs),
        ).dispose_with(self)
        self._closeEvent_wrap = QFuncWrap(
            q_widget,
            "closeEvent",
            lambda *args, **kwargs: self._close_event(*args, **kwargs),
        ).dispose_with(self)
        self._changeEvent_wrap = QFuncWrap(
            q_widget,
            "changeEvent",
            lambda *args, **kwargs: self._change_event(*args, **kwargs),
        ).dispose_with(self)
        self._resizeEvent_wrap = QFuncWrap(
            q_widget,
            "resizeEvent",
            lambda *args, **kwargs: self._resize_event(*args, **kwargs),
        ).dispose_with(self)
        self._focusInEvent_wrap = QFuncWrap(
            q_widget,
            "focusInEvent",
            lambda *args, **kwargs: self._focus_in_event(*args, **kwargs),
        ).dispose_with(self)
        self._focusOutEvent_wrap = QFuncWrap(
            q_widget,
            "focusOutEvent",
            lambda *args, **kwargs: self._focus_out_event(*args, **kwargs),
        ).dispose_with(self)
        self._enterEvent_wrap = QFuncWrap(
            q_widget,
            "enterEvent",
            lambda *args, **kwargs: self._enter_event(*args, **kwargs),
        ).dispose_with(self)
        self._leaveEvent_wrap = QFuncWrap(
            q_widget,
            "leaveEvent",
            lambda *args, **kwargs: self._leave_event(*args, **kwargs),
        ).dispose_with(self)
        self._moveEvent_wrap = QFuncWrap(
            q_widget,
            "moveEvent",
            lambda *args, **kwargs: self._move_event(*args, **kwargs),
        ).dispose_with(self)
        self._keyPressEvent_wrap = QFuncWrap(
            q_widget,
            "keyPressEvent",
            lambda *args, **kwargs: self._key_press_event(*args, **kwargs),
        ).dispose_with(self)
        self._keyReleaseEvent_wrap = QFuncWrap(
            q_widget,
            "keyReleaseEvent",
            lambda *args, **kwargs: self._key_release_event(*args, **kwargs),
        ).dispose_with(self)
        self._mouseMoveEvent_wrap = QFuncWrap(
            q_widget,
            "mouseMoveEvent",
            lambda *args, **kwargs: self._mouse_move_event(*args, **kwargs),
        ).dispose_with(self)
        self._mousePressEvent_wrap = QFuncWrap(
            q_widget,
            "mousePressEvent",
            lambda *args, **kwargs: self._mouse_press_event(*args, **kwargs),
        ).dispose_with(self)
        self._mouseReleaseEvent_wrap = QFuncWrap(
            q_widget,
            "mouseReleaseEvent",
            lambda *args, **kwargs: self._mouse_release_event(*args, **kwargs),
        ).dispose_with(self)
        self._wheelEvent_wrap = QFuncWrap(
            q_widget,
            "wheelEvent",
            lambda *args, **kwargs: self._wheel_event(*args, **kwargs),
        ).dispose_with(self)
        self._paintEvent_wrap = QFuncWrap(
            q_widget,
            "paintEvent",
            lambda *args, **kwargs: self._paint_event(*args, **kwargs),
        ).dispose_with(self)
    ...
    @property
    def mx_show(self) -> mx.IEvent1_rv[qt.QShowEvent]:
        return self._mx_show

    @property
    def mx_hide(self) -> mx.IEvent1_rv[qt.QHideEvent]:
        return self._mx_hide

    @property
    def mx_close(self) -> mx.IEvent1_rv[qt.QCloseEvent]:
        return self._mx_close

    @property
    def mx_change(self) -> mx.IEvent1_rv[qt.QEvent]:
        return self._mx_change

    @property
    def mx_resize(self) -> mx.IEvent1_rv[qt.QResizeEvent]:
        return self._mx_resize

    @property
    def mx_focus_in(self) -> mx.IEvent1_rv[qt.QFocusEvent]:
        return self._mx_focus_in

    @property
    def mx_focus_out(self) -> mx.IEvent1_rv[qt.QFocusEvent]:
        return self._mx_focus_out

    @property
    def mx_enter(self) -> mx.IEvent1_rv[qt.QEnterEvent]:
        return self._mx_enter

    @property
    def mx_leave(self) -> mx.IEvent1_rv[qt.QEvent]:
        return self._mx_leave

    @property
    def mx_move(self) -> mx.IEvent1_rv[qt.QMoveEvent]:
        return self._mx_move

    @property
    def mx_key_press(self) -> mx.IEvent1_rv[qt.QKeyEvent]:
        return self._mx_key_press

    @property
    def mx_key_release(self) -> mx.IEvent1_rv[qt.QKeyEvent]:
        return self._mx_key_release

    @property
    def mx_mouse_move(self) -> mx.IEvent1_rv[qt.QMouseEvent]:
        return self._mx_mouse_move

    @property
    def mx_mouse_press(self) -> mx.IEvent1_rv[qt.QMouseEvent]:
        return self._mx_mouse_press

    @property
    def mx_mouse_release(self) -> mx.IEvent1_rv[qt.QMouseEvent]:
        return self._mx_mouse_release

    @property
    def mx_wheel(self) -> mx.IEvent1_rv[qt.QWheelEvent]:
        return self._mx_wheel

    @property
    def mx_paint(self) -> mx.IEvent1_rv[qt.QPaintEvent]:
        return self._mx_paint
    ...
    @property
    def q_widget(self) -> qt.QWidget:
        return self.q_object

    @property
    def q_font(self) -> qt.QFont:
        return self.q_widget.font()

    @property
    def q_style(self) -> qt.QStyle:
        return self.q_widget.style()

    @property
    def q_palette(self) -> qt.QPalette:
        return self.q_widget.palette()

    @property
    def rect(self) -> qt.QRect:
        return self.q_widget.rect()

    @property
    def size(self) -> qt.QSize:
        return self.q_widget.size()

    @property
    def visible(self) -> bool:
        return self.q_widget.isVisible()

    def map_to_global(self, point: qt.QPoint) -> qt.QPoint:
        return self.q_widget.mapToGlobal(point)

    def h_compact(self, size: int = None):
        self._min_width = size
        self._max_width = size
        self.q_widget.setSizePolicy(
            qt.QSizePolicy.Policy.Fixed, self.q_widget.sizePolicy().verticalPolicy()
        )
        return self
    ...
    def v_compact(self, size: int = None):
        ...
        self.q_widget.setSizePolicy(
            self.q_widget.sizePolicy().horizontalPolicy(), qt.QSizePolicy.Policy.Fixed
        )
        return self
    ...
    def h_normal(self, min: int = None, max: int = None):
        ...
        self.q_widget.setSizePolicy(
            qt.QSizePolicy.Policy.Preferred, self.q_widget.sizePolicy().verticalPolicy()
        )
        return self
    ...
    def v_normal(self, min: int = None, max: int = None):
        ...
        self.q_widget.setSizePolicy(
            self.q_widget.sizePolicy().horizontalPolicy(),
    ...
    def h_expand(self, min: int = None, max: int = None):
        ...
        self.q_widget.setSizePolicy(
            qt.QSizePolicy.Policy.Expanding, self.q_widget.sizePolicy().verticalPolicy()
        )
        return self
    ...
    def set_tooltip(self, tooltip: str):
        if (disp := getattr(self, "_QWidget_tooltip_disp", None)) is not None:
            disp.dispose()
        self._QWidget_tooltip_disp = (
            QApplication.instance()
            .mx_language.reflect(
                lambda lang: self.q_widget.setToolTip(lx.L(tooltip, lang))
            )
            .dispose_with(self)
        )
        return self
