...
class QInfoBar(QHBox):
    ...
    def __init__(self):
        ...
        self._upd_timer = (
            QTimer(self._on_timer).set_parent(self).set_interval(100).start()
        )
        ...
        (
            ...
            .add(
                ...
                .add(
                    QVFrame()
                    .add(self._title_label.hide(), align=Align.CenterH)
                    .v_compact()
                )
                .add(self._te)
            )
            .add(
                ...
                .inline(lambda btn: btn.mx_clicked.listen(self._on_btn_done))
            )
        )  # lambda: (self._te.clear(), self.hide())))))
    ...
    def add_text(self, text: str):
        ...
        self._pending_text_strings.append(
            lx.L(text, QApplication.instance().mx_language.get())
        )
