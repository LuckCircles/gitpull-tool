...
class QAbstractSpinBox(QWidget):
    def __init__(self, **kwargs):
        ...
        self._mx_editing_finished = QEvent0(
            q_abstract_spin_box.editingFinished
        ).dispose_with(self)
    ...
    @property
    def q_abstract_spin_box(self) -> qt.QAbstractSpinBox:
    ...
    def set_special_value_text(self, text: str | None):
        ...
        self._QAbstractSpinBox_svt_disp = (
            ...
            .mx_language.reflect(
                lambda lang: self.q_abstract_spin_box.setSpecialValueText(
                    lx.L(text, lang)
                )
            )
            .dispose_with(self)
