...
class QPushButton(QAbstractButton):
    def __init__(self, **kwargs):
        super().__init__(
            q_abstract_button=q_init("q_pushbutton", qt.QPushButton, **kwargs), **kwargs
        )
    ...
    @property
    def q_pushbutton(self) -> qt.QPushButton:
    ...
    def set_text(self, text: str | None):
        ...
        self._QAbstractButton_text_disp = (
            ...
            .mx_language.reflect(lambda lang: self.__label.setText(lx.L(text, lang)))
            .dispose_with(self)
        )
        return self
