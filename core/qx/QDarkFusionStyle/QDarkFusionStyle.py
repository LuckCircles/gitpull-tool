...
class QDarkFusionStyle(qt.QProxyStyle):
    ...
    def polish(self, obj: qt.QObject):
        ...
        if isinstance(obj, qt.QPalette):
            ...
            pal.setColor(
                qt.QPalette.ColorRole.PlaceholderText, StyleColor.PlaceholderText
            )
            ...
            pal.setColor(
                qt.QPalette.ColorRole.HighlightedText, StyleColor.HighlightedText
            )
            ...
            pal.setColor(
                qt.QPalette.ColorGroup.Inactive,
                qt.QPalette.ColorRole.ButtonText,
                StyleColor.ButtonText,
            )
            pal.setColor(
                qt.QPalette.ColorGroup.Disabled,
                qt.QPalette.ColorRole.ButtonText,
                StyleColor.ButtonTextDisabled,
            )

            pal.setColor(
                qt.QPalette.ColorGroup.Active,
                qt.QPalette.ColorRole.WindowText,
                StyleColor.WindowText,
            )
            pal.setColor(
                qt.QPalette.ColorGroup.Inactive,
                qt.QPalette.ColorRole.WindowText,
        ...
        if isinstance(obj, qt.QMenuBar):
            ...
            pal.setColor(
                qt.QPalette.ColorRole.Window, pal.color(qt.QPalette.ColorRole.Mid)
            )
            obj.setPalette(pal)
...
"""
    ...
    def pixelMetric(
        self, metric: QStyle.PixelMetric, option: qt.QStyleOption, widget: qt.QWidget
    ) -> int:
...
class QWidgetFilter(qt.QObject):
    def __init__(self):
        ...
        self._funcs = {
            qt.QEvent.Type.Wheel: self._wheel_filter,
    ...
    def _wheel_filter(self, obj: qt.QObject, ev: qt.QWheelEvent):
        ...
        if isinstance(
            obj, (qt.QAbstractSpinBox, qt.QAbstractSlider, qt.QTabBar, qt.QComboBox)
    ...
    def _leave_filter(self, obj: qt.QObject, ev: qt.QWheelEvent):
        if isinstance(
            obj,
            (qt.QAbstractButton, qt.QAbstractSpinBox, qt.QAbstractSlider, qt.QComboBox),
        ):
            obj.clearFocus()
        return False
